        ...
        <main style={{ padding: 'var(--spacing-lg) var(--spacing-md)', maxWidth: '800px', margin: '0 auto', paddingBottom: '100vh' }}>
            <section className="glass-card" style={{ padding: '30px', textAlign: 'left' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', fontSize: '0.9rem', lineHeight: '1.7', color: 'var(--text-secondary)' }}>
                    ...
                    <p>
                        <strong>3. Registration:</strong> Fees (Individual: ₹799 - ₹1,499, Team: ₹1,999 - ₹3,499) vary by phase and are technical processing fees. They are non-refundable. Support queries: <a href="mailto:talentforge@zaukritievents.in" style={{ color: 'var(--accent-gold)' }}>talentforge@zaukritievents.in</a>.
                    </p>
                    <p>
                    ...
                    <div id="referral" style={{ scrollMarginTop: '150px' }}>
                        <p><strong>7. Community Referrers:</strong></p>
                        <p>Institutional partners (College Ambassadors) act as promotional partners and are not participants/applicants unless registered separately. Referral credits (₹50) are promotional and internal; they do not constitute wages or commissions.</p>
                    </div>
                    <p>
                    ...
                    <div id="internship" style={{ scrollMarginTop: '150px' }}>
                        <p><strong>10. Evaluation & Internship:</strong></p>
                        <p>Selection for internships is strictly performance-based. Registration does NOT guarantee an internship, full-time role, or stipend. Internship engagements are a continuation of the evaluation process, not a purchased benefit. Stipends are provided only to selected interns based on performance.</p>
                    </div>

                    <div id="timeline" style={{ scrollMarginTop: '150px' }}>
                        <p><strong>11. Timeline & Enrolment:</strong></p>
                        <p>Enrolments close strictly by the end of March. No new registrations are accepted post-deadline. Evaluation occurs in May, results in June.</p>
                    </div>

                    <div id="certification" style={{ scrollMarginTop: '150px' }}>
                        <p><strong>12. Certification:</strong></p>
                        <p>A Digital Participation Certificate is awarded to all completers. Internship Certificates are awarded ONLY upon successful completion of the internship tenure. Certificates do not serve as employment guarantees.</p>
                    </div>
                </div>
